  ...
  return (
    <div className="flex gap-5 py-10 xl:py-20">
      <div className="flex flex-col gap-2 h-fit self-center">
        ...
        <img src="/images/left-frame.png" className="sm:scale-150 object-cover" />
      </div>
      <div className="text-center space-y-5 lg:space-y-10">
        <h1 className="font-satoshi-bold text-xl sm:text-2xl md:text-3xl md:leading-snug lg:text-5xl lg:leading-[80px] xl:text-7xl xl:leading-[80px]">
          Strategic Solutions for{" "}
          <span className="text-green">Government & Commercial Clients</span>
        </h1>
        <p className="text-green mx-auto w-11/12 lg:w-8/12 text-[10px] sm:text-sm md:text-base">
      ...
      <div className="flex flex-col gap-2 self-center h-fit">
        ...
        <img src="/images/right-frame.png" className="sm:scale-150 object-cover" />
      </div>
    </div>
  );
}
