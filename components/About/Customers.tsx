  ...
  return (
    <div id="customers">
      ...
      <div className="flex flex-col lg:flex-row justify-center gap-5 py-5">
        <ul className="flex flex-col gap-5 lg:py-10 [&>*]:bg-green text-white text-lg lg:text-2xl [&>*]:px-10 [&>*]:py-6 [&>*]:rounded-xl [&>*]:self-end [&>*]:w-full text-center">
          <li>Government Agencies</li>
          <li>Large and Small businesses</li>
          <li> Healthcare Institutes</li>
        </ul>
        <ul className="flex flex-col gap-5 lg:py-10 [&>*]:bg-green text-white text-lg lg:text-2xl [&>*]:px-10 [&>*]:py-6 [&>*]:rounded-xl [&>*]:w-full text-center">
